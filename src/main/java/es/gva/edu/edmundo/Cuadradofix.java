 ...
 * Test of getLado method, of class Cuadrado.  */ 
 ...
 System.out.println("getLado");  Cuadrado instance = c0; 
 int expResult = 0; 
 int result = instance.getLado();  assertEquals(expResult, result);   
 assertEquals(c1.getLado(), 1);  assertEquals(c8.getLado(), 8);  assertEquals(cn5.getLado(), 0);   
 } 
 /** 
 * Test of setLado method, of class Cuadrado.  */ 
 @Test 
 public void testSetLado() { 
 System.out.println("setLado");  int lado = 10; 
 Cuadrado instance = new Cuadrado(10);  instance.setLado(lado); 
 ...
 * Test of calcularArea method, of class Cuadrado.  */ 
 ...
 System.out.println("calcularArea");  Cuadrado instance = c0; 
 double expResult = 0.0; 
 double result = instance.calcularArea();  assertEquals(expResult, result, 0); 
 ...
 * Test of calcularPerimetro method, of class Cuadrado.  */ 
 ...
 System.out.println("calcularPerimetro");  Cuadrado instance = c0; 
 double expResult = 0.0; 
 double result = instance.calcularPerimetro();  assertEquals(expResult, result, 0); 
